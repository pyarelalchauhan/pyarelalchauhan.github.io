...
- **A Data-Driven Framework for Pedestrian Oriented Route Planning Leveraging Deep Learning and Spatial Perception**  
  ...
  *International Journal of Applied Earth Observation and Geoinformation, vol. 144, Article 104932, 2025*  
  🔗 https://doi.org/10.1016/j.jag.2025.104932

- **Urban Multi-Domain Mixing (UMDMix) Based Unsupervised Domain Adaptation for LiDAR Semantic Segmentation**  
  A. Nihal, **Pyare Lal**, and V. Kumar  
  *Neurocomputing, Article 131526, 2025*  
  🔗 https://doi.org/10.1016/j.neucom.2025.131526

- **Deep Learning and Multi-Source 2D and 3D Geospatial Data for Urban Quality of Life Assessment**  
  A. Dabra, **Pyare Lal Chauhan**, and V. Kumar  
  *International Journal of Applied Earth Observation and Geoinformation, vol. 144, Article 104838, 2025*  
  🔗 https://doi.org/10.1016/j.jag.2025.104838
...
- **Addressing Class Imbalance Challenge in Semantic Segmentation of ALS Data Through Performance Analysis of RandLA-Net and PointNet++**  
  **Pyare Lal Chauhan**, J. Vijaywargiya, and A. M. Ramiya  
  *IEEE India Geoscience and Remote Sensing Symposium (InGARSS), Bangalore, India, 2023, pp. 1–4*  
  🔗 https://ieeexplore.ieee.org/document/10490326  

---

## Preprints

*(No preprints currently available)*
